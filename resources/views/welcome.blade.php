                    ...
                    <div class="p-4 text-center md:p-12 lg:text-left">
                        ...
                        <div class="mb-4">
                            <a href="{{ route('orders.create') }}">
                                <button
                                    class="text-accent hover:bg-dark dark:border-accent dark:text-accent dark:hover:bg-accent mb-2 me-2 rounded-lg border border-gray-800 px-5 py-2.5 text-center text-sm font-bold hover:text-white focus:outline-none focus:ring-4 focus:ring-gray-300 dark:hover:text-white dark:focus:ring-gray-800 transition-all duration-100"
                                    type="button">
                                    {{ $content->cta_text }}
                                </button>
                            </a>
                        ...
                        <div class="mx-auto mt-6 flex w-4/5 flex-wrap items-center justify-between pb-16 lg:w-full lg:pb-0">
                            <a class="link" data-tippy-content="@github_handle" href="#"><svg
                                    class="text-dark h-6 fill-current hover:text-accent hover:scale-110 transition-all duration-100" role="img"
